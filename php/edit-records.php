                ...
                <div>
                    <?php if (mysqli_num_rows($sql2) > 0): ?>
                        <?php while ($row = mysqli_fetch_row($sql2)) : ?>
                            ...
                            <div class="img-selector">
                                <img loading="lazy" class="admin-edit-photo myImg" id="myImg1" src=".<?php echo $imageSrc; ?>" alt="error">
                                <div id="myModal" class="modal">
                                    <span class="close">&times;</span>
                                    <img class="admin-edit-photo modal-content" id="img01" alt="image not present" src=".<?php echo $imageSrc; ?>">
                                </div>
                    ...
                    <?php else : ?>
                        <div class="img-selector">
                            ...
                            <div id="myModal" class="modal">
                                <span class="close">&times;</span>
                                <img class="admin-edit-photo modal-content" id="img01" alt="image not present" src="">
                            </div>
                            <input type="file" name="image[]" id="image" accept="image/jpg, image/jpeg, image/png">
                        </div>
                    <?php endif; ?>
