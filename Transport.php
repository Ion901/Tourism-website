...
<body>
    <section>
        ...
        <div class="maps">
            ...
            <div class="mas-in">
                <div class="belarus">
                    <img src="./images/belarus.png" loading="lazy" alt="error">
                    <p>Belarus</p>
                </div>
                <div class="cehia">
                    <img src="./images/czech-republic.png" loading="lazy" alt="error">
                    <p>Republica <br> Cehă</p>
                </div>
                <div class="franta">
                    <img src="./images/france.png" loading="lazy" alt="error">
                    <p>Franța</p>
                </div>
                <div class="grecia">
                    <img src="./images/greece.png" loading="lazy" alt="error">
                    <p>Grecia</p>
                </div>
                <div class="moldova">
                    <img src="./images/moldova.png" loading="lazy" alt="error">
                    <p>Republica <br> Moldova</p>
                </div>
                <div class="slovenia">
                    <img src="./images/slovenia.png" loading="lazy" alt="error">
                    <p>Slovenia</p>
                </div>
                <div class="romania">
                    <img src="./images/romania.png" loading="lazy" alt="error">
                    <p>România</p>
                </div>
                <div class="olanda">
                    <img src="./images/netherlands.png" loading="lazy" alt="error">
                    <p>Olanda</p>
                </div>
                <div class="spania">
                    <img src="./images/spain.png" loading="lazy" alt="error">
                    <p>Spania</p>
                </div>
            </div>
        </div>
