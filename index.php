...
<body>
    <section>
        ...
        <div class="options">
            <img src="./images/pexels-pat-whelen-5615401.jpg" loading="lazy" alt="foto lispeste" class="f1">
            <img src="./images/pexels-dhyamis-kleber-2882378.jpg" loading="lazy" alt="foto lispeste" class="f2">
            <img src="./images/pexels-oleg-magni-1837610.jpg" loading="lazy" alt="foto lispeste" class="f3">
        </div>
        </nav>
        </div>
        <div class="qoutes">
        ...
        <div id="slider">
            <ul id="slideWrap">
                <li><img id="i1" src="./images/cd993743a7f699d20cda8fbc7546d76a.jpg" loading="lazy"
                        alt="image not working">
                    <div class="overlay">INTERNAȚIONAL</div>
                </li>
                <li><img src="./images/271393836_2183210335179967_9205213809527780883_n.jpg" loading="lazy"
                        alt="image not working">
                    <div class="overlay">PELERINAJE</div>
                </li>
                <li><img src="./images/802589.jpg" loading="lazy" alt="image not working">
                    <div class="overlay">DEPLASARI</div>
                </li>
                <li><img src="./images/yang-wewe-OsFGJ3vXe9Q-unsplash.jpg" loading="lazy" alt="photo is not working">
                    <div class="overlay">MARE</div>
                </li>
                <li><img src="./images/mads-schmidt-rasmussen-xfngap_DToE-unsplash.jpg" loading="lazy"
                        alt="photo unsplash">
                    <div class="overlay">MUNTE</div>
                </li>
                <li><img src="./images/61646-washington-wallpaper-washington-wizards.jpg" loading="lazy"
                        alt="photo unsplash">
        ...
        <div class="ctn2">
            <div class="left">
                ...
                <a href="detalii.php?<?php echo "city=" . $row2['city'] ?>"><button type="button" value="Detalii"
        ...
        <div class="ctn3">
            ...
            <div class="right2">
                ...
                <a href="detalii.php?<?php echo "city=" . $row['city'] ?>"><button type="button" value="Detalii"
        ...
        <div class="griding">
            <div class="paris">
                <a href="detalii.php?city=<?php echo $row3['city'] ?>">
                    <img src="./images/pexels-nicolas-2267339.jpg" loading="lazy" alt="image not respond">
                    <div class="text">
                        <p>Paris, France</p>
            ...
            <div class="cambodgia">
                <a href="detalii.php?city=<?php echo  $row4['city'] ?>">
                    <img src="./images/pexels-te-lensfix-1371360.jpg" loading="lazy" alt="image not respond">
                    <div class="text1">
            ...
            <div class="egipt">
                <a href="detalii.php?city=<?php echo  $row5['city'] ?>">
                    <img src="./images/pexels-rachel-claire-4577718.jpg" loading="lazy" alt="image not respond">
                    <div class="text2">
                        <p>Giza, Egipt</p>
            ...
            <div class="tokyo">
                <a href="detalii.php?city=<?php echo $row6['city'] ?>">
                    <img src="./images/pexels-pat-whelen-5615401.jpg" loading="lazy" alt="image not respond">
                    <div class="text3">
