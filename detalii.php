...
<body>
    ...
    <section>
        ...
        <div class="continut">
            <div class="left">
                <div class="grid-template">
                    <div><p><i class="fa-solid fa-clock"></i><span class="disponibilitate"><?= $row['durata']?></span></p></div>
                    <div><p><i class="fa-solid fa-plane-departure"></i>Chisinau</p></div>
                    <div><p><i class="fa-solid fa-user"></i>Varsta min: 0+ </p></div>
                    <div><p><i class="fa-solid fa-calendar"></i>Disponibilitate: <?= $row['disponibility']?></p></div>
                    <div><p><i class="fa-solid fa-plane-arrival"></i> <span class="tara"><?= $row['country']?></span></p></div>
                </div>
            </div>
            <div class="right1">
                <div class="position">
            ...
            while ($photo = mysqli_fetch_assoc($sql)) {
                ?>
                <div><img src="<?= $photo['path']; ?>" alt="error" class="img1"></div>
                <?php
            }
            ?>
            </div>
            ...
            <div class="pret-ctn">
                <div class="price" id="pret">
                        <p>Preț - <?= $row['price']?>€ <p class="pret_moldavskii"></p></p>
                </div>
        ...
        <div class="reservations">
           <a href="book.php"><button class="rezer" id="rezerva"> <input type="hidden" class="id" id="<?= htmlspecialchars($id_info)?>">Rezervă aici</button></a>
        </div>
        <div class="footer">
            <div class="logo">
